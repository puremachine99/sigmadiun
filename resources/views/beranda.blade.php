    ...
    <section class="hero-section">
        <div class="container">
            <div class="hero-content">
                <h1 class="hero-title">Kabupaten Madiun: Destinasi Investasi Tumbuh & Terukur</h1>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="sector-card">
                        ...
                        <div class="sector-content">
                            ...
                            <h3>Agribisnis</h3>
                            <p>Kabupaten Madiun memiliki lahan pertanian subur seluas 50.000 hektar dengan produksi padi
                                mencapai 500.000 ton per tahun.</p>
